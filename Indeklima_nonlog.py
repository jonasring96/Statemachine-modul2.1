...
from time import *
#import #loggong
#import #loggong.handlers
import bme680
#opsætning af Knapperne tallene der står i GPIO.setup er GPIO portenes nr
GPIO.setmode(GPIO.BCM)
GPIO.setup(16, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
GPIO.setup(14, GPIO.IN, pull_up_down=GPIO.PUD_DOWN)
#Denne linie laver filen Indeklima.log inde i log mappen. og sætter #loggong level til debug
now = ctime(int(time()))
#loggong.basicConfig(filename='log/Indeklima.log',level=#loggong.DEBUG)
